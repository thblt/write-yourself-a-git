...
#+begin_src emacs-lisp :exports none :results none
  (let ((org-babel-inline-result-wrap "%s")
    ...
    (when (string= "thblt" (user-login-name))
      ...
      (shell-command "scp -r org-html-themes/src k9.thb.lt:/var/www/wyag.thb.lt/")))
#+end_src
...
- =ls-files= ([[#cmd-ls-files][wyag source]]) [[https://git-scm.com/docs/git-ls-files][git man page]]
...
| Key              | Value                             |
|------------------+-----------------------------------|
| Creation date    | Tue Nov  1 18:21:23 2022          |
| On commit        | =0.1-34-gdd9b284= (*dirty*)       |
| By               | Thibault Polge (=thblt= on =dru=) |
| Emacs version    | 29.0.50                           |
| Org-mode version | 9.6-pre                           |
